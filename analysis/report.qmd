...
Political polarization  @example2024 creates challenges for marketers who must communicate effectively with ideologically [@example2024] diverse consumers. 
...
At baseline, Democrats were more biased about Republicans (*M* = `r sprintf("%.2f", mean_dr)`, *SD* = `r sprintf("%.2f", sd_dr)`) than Republicans were about Democrats (*M* = `r sprintf("%.2f", mean_rd)`, *SD* = `r sprintf("%.2f", sd_rd)`), *d* = `r d`, *p* = `r sprintf("%.3f", p)`.
...
Does baseline accuracy predict baseline confidence?
