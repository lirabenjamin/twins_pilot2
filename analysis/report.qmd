...
accuracy_time_coef <- abs(fixef(accuracy_model0)["timepost"])
...
Republicans learning about Democrats gained confidence after the interaction, despite learning less than Democrats. Democrats' confidence did not change. See Figure below.
