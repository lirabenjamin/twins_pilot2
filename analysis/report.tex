...
\pandocbounded{\includegraphics[keepaspectratio]{report_files/figure-pdf/baseline-accuracy-warmth-correlation-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{report_files/figure-pdf/accuracy-warmth-change-correlation-1.pdf}}
...
(\emph{b} = -0.007, \emph{p} = 0.185), and for warmth was not
significant (\emph{b} = 0.08, \emph{p} = 0.315). More and less extreme
participants were equally likely to update their beliefs and warmth
toward the outgroup.
...
\pandocbounded{\includegraphics[keepaspectratio]{report_files/figure-pdf/unnamed-chunk-9-1.pdf}}
