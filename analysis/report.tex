...
points on the 5-point scale) and warmer toward the outgroup (increasing
by 4.3 degrees on the 100-point thermometer).
...
Republicans who showed greater improvement (\emph{b} = 0.63, \emph{p}
\textless{} .001). Republicans also became less biased about Democrats,
though to a lesser extent (\emph{b} = 0.16, \emph{p} = 0.002). The
interaction term was significant (\emph{b} = -0.46, \emph{p} \textless{}
.001).
...
(\emph{p} \textless{} .001), while Republicans learning about Democrats
increased by 3.5 degrees (\emph{p} \textless{} .001). The interaction
was not significant (\emph{b} = -1.60, \emph{p} = 0.127).
...
at baseline (\emph{b} = -0.012, \emph{p} \textless{} .001) and felt less
warm toward them (\emph{b} = -0.54, \emph{p} \textless{} .001). However,
political extremism did not moderate the effect of the chatbot
interaction. The three-way interaction for accuracy was not significant
(\emph{b} = 0.007, \emph{p} = 0.185), and for warmth was not significant
(\emph{b} = 0.08, \emph{p} = 0.315). More and less extreme participants
were equally likely to update their beliefs and warmth toward the
outgroup.
...
interaction (\emph{b} = 0.306, \emph{p} \textless{} .001), despite
learning less than Democrats. Democrats' confidence did not
significantly change (\emph{b} = -0.065, \emph{p} = 0.328).
...
[11] backports_1.5.0     labeling_0.4.3      effectsize_1.0.1    promises_1.3.3      rmarkdown_2.29     
[16] tzdb_0.5.0          ps_1.9.1            nloptr_2.2.1        ragg_1.4.0          bit_4.6.0          
[21] xfun_0.52           litedown_0.7        later_1.4.2         parallel_4.5.0      broom_1.0.9        
[26] R6_2.6.1            tables_0.9.31       stringi_1.8.7       RColorBrewer_1.1-3  car_3.1-3          
[31] boot_1.3-31         lmtest_0.9-40       numDeriv_2016.8-1.1 estimability_1.5.1  Rcpp_1.0.14        
[36] assertthat_0.2.1    knitr_1.50          zoo_1.8-14          parameters_0.28.0   splines_4.5.0      
[41] timechange_0.3.0    tidyselect_1.2.1    abind_1.4-8         yaml_2.3.10         websocket_1.4.4    
