...
(\citeproc{ref-hermann_reducing_2025}{Hermann et al., 2025}). Digital
twins built from survey data can accurately represent individuals'
psychological characteristics
(\citeproc{ref-park_generative_nodate}{Park et al., n.d.};
\citeproc{ref-toubia_database_2025}{Toubia et al., 2025}), but whether
marketers can extract this knowledge through conversation remains
untested.
...
Democrats, 252 Republicans) who conversed with a chatbot prompted to
represent their political outgroup and estimated outgroup attitudes
toward environmental consumption before and after the interaction. We
...
\emph{d} = -1.32, \emph{p} \textless{} .001.
...
Does baseline accuracy predict baseline confidence? {[}TO-DO: Move this
to the confidence section at the end of results.{]} We examine whether
...
We collected data via Qualtrics from 500 participants. Of these, 248
were Democrats learning about Republicans (D→R) and 252 were Republicans
learning about Democrats (R→D). Participants self-reported their
political orientation on a 0-100 slider scale, where values below 50
indicate Democratic leaning and values 50 and above indicate Republican
leaning.
...
\bibitem[\citeproctext]{ref-park_generative_nodate}
Park, J. S., Zou, C. Q., Shaw, A., Hill, B. M., Cai, C., Morris, M. R.,
Willer, R., Liang, P., \& Bernstein, M. S. (n.d.). \emph{Generative
...
\bibitem[\citeproctext]{ref-toubia_database_2025}
Toubia, O., Gui, G. Z., Peng, T., Merlau, D. J., Li, A., \& Chen, H.
(2025). Database {Report}: {Twin}-{2K}-500: {A} {Data} {Set} for
{Building} {Digital} {Twins} of over 2,000 {People} {Based} on {Their}
{Answers} to over 500 {Questions}. \emph{Marketing Science},
mksc.2025.0262. \url{https://doi.org/10.1287/mksc.2025.0262}
